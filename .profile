...
# exists. see /usr/share/doc/bash/examples/startup-files for examples. the files are located in the bash-doc package.
...
# $HOME/Projects/keyboard/chkstdin > $HOME/Projects/keyboard/chkstdin.log
